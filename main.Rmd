...
Remove the camp Id from the Data since it's useless in findind the price of the house. then substitute saleprice by log(saleprice)

```{r}
training.set <- subset(training.set, select = -Id )
training.set$SalePrice = log(training.set$SalePrice)
head(training.set)
```
